...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($foto_error === UPLOAD_ERR_OK) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            header("Location: update_kk.php?success=1");
            exit();
        } else {
            echo "Gagal memperbarui data dan foto KK: " . mysqli_error($conn);
        }
    } else {
...
<head>
    ...
    <title>Update Kartu Keluarga | SIP</title>
    ...
    <nav class="navbar flex">
      <i class="bx bx-menu" id="sidebar-open"></i>
        ...
        <section>
            ...
            <div class="attention">
                <h2>PERHATIAN!</h2>
                <p>Harap Update Kartu Keluarga dengan benar</p>
            </div>
            <form action="update_kk.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="form-input">
                        <label for="foto_kk">Update Foto Kartu Keluarga Anda</label>
                        <input type="file" name="foto_kk" id="foto_kk" required>
                    </div> <br>
                    <input type="submit" class="submit" value="submit" name="submit">
                   <a class="btn btn-danger" href="input_kk.php" style="margin-left: 10px">kembali</a>
                </div>
            </form>
        </section>
    </div>
