    ...
    <div class="header">
        ...
        <div class="contact">
                <div class="contact-image">
                    <img src="images/rt01.png" alt="contact-image">
                </div>
                <div class="list-contact">
                    <ul>
                        <li><i class='bx bxs-user'></i>  La Capi</li>
                        <li><i class='bx bx-phone-call' ></i>  +62 822-7148-4738</li>
                        <li> <i class='bx bx-envelope'></i> lacapi3001@gmail.com</li>
                    </ul>
                </div>
        </div>
    </section>
